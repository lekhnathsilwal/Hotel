	...
	<?php
		if(isset($_POST['submit'])){							//fetching variables of the form which travels in url
			...
			if($f_name!=='' && $l_name!=='' && $email!=='' && $confirm_password==$pswrd && $user_name!==''){
				...
				if($result){		
					$_SESSION['msg']="Your account is created successfully";
					header('location:userlogin.php');
					exit();
				}
				else{
					$_SESSION['msg']="Sorry we can not create your account";
					header('location:signup.php');	
					exit();
				}
			}
		...
		?>
		<fieldset>
			<legend>Add Your Details Here To Sign Up</legend>
			<h2 style="color:red; text-transform:capitalize;"><?php echo $msg; ?></h2>  
			<form action="signup.php" method="post">
				...
				<tr>
					...
					<td><input type="text" name="m_name" placeholder="enter last name" id="m_name" value=""/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="email" placeholder="enter email" id="email" value="" required/></td>
				</tr>
				<tr>
