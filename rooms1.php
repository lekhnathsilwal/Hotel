		...
		<div id="room">
			...
			<div class="status">
				...
				if($count5['status']=='available'){
					?>
						<p>status:<a href="booking.php?roomnumber=<?php echo $count5['room_number']; ?>" ><span><?php echo $count5['status'];  ?></a></span></p>
				...
				?>
					<p>status:<span style="color:red;"><?php echo $count5['status'];  ?></span></p>
				<?php
				}
				?>
