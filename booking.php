...
<div id="wrap">
	...
	if(isset($_GET['booked'])){
		...
		?>
			<center>
			<h2>Room is booked you have to confirm your reservation with in 10 hours from check in date with payment</h2>
			<div id="room">
			...
			<form action="booking1.php" method="post">
				...
				<tr>
					...
					<td style="color:green;">
						<?php 
						if(isset($_GET['booked'])){
							echo "Room is booked you have to confirm your reservation with in 10 hours with payment .!!!";
						}
						?>
					</td>
				</tr>
