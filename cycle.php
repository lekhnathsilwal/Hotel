<div id="sliding_banner">
	...
	<div id="slider_container">
		<div id="slider">
			<?php				
			$query5 = "SELECT * FROM rooms limit 40";
			$result5 = mysqli_query($connection,$query5);
			while($count5=mysqli_fetch_array($result5)){
				?>
				<div class="slider1">
					<div class="foto">
						<img id="slide" src="admin/img/uploaded_images/<?php echo $count5['room_image']; ?>" height="350" width="800"/>
						<img id="logo" src="images/Untitled-7.png"/>
					</div>
					<div class="info">
						<center><h1><?php echo $count5['room_name']; ?></h1></center>
